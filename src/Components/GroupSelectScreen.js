...
/*
    ...
    * src
*/
function GroupButton({color, groupTitle, avatarList}) {
    let avatarIconList = []
        ...
        <React.Fragment>
            <Button style={{width: "auto", height: "auto", backgroundColor: color, 
                ...
                <Box className="group-button-flex-wrapper">
                    ...
                    <div style={{backgroundColor: "white", width: "auto", height: 45, 
                                 borderRadius: 10, alignSelf: "center", marginLeft: 20, 
                                 marginRight: 7, display: "flex"}}>
                        <div style={{alignSelf:"center"}}>
                            <p style={{margin: 10, marginRight: 2, color: "#D34C4C", 
                                       fontSize: 8, lineHeight: 1.4}}>
                                You<br/>Owe
                            </p>
                        </div>
                        <p style={{margin: 10, color: "#D34C4C", 
